...
plot(importance1)+
  ggtitle("Feature Importance plot of Random Forest")+
...
plot(importance2)+
  ggtitle("Feature Importance plot of sequential Random Forest")+
  theme_minimal(base_size = 14)
```
...
plot(importance3) +
  ggtitle("Feature Importance plot of sequential GAM implementaion")+
  theme_minimal(base_size = 14)
```
